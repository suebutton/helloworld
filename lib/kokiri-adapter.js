...
class KokiriAdapter {
  ...
  static supportMatrixFromBuilder(getBuilder, url, platform) {
    ...
    try {
      ...
      const appAction = builder.appActionFromUrl(
        url,
        platform,
        mockSourceToken
      );

      const webAction = builder.webActionFromUrl(
        url,
        platform,
        mockSourceToken
      );
  ...
  appAction(url, publisherId, platform, attributionToken, ctx, originalUrl) {
    ...
    try {
      ...
      appAction = kokiriConfig
        .createBuilderByUrl(publisherId, url)
        .appActionFromUrl(url, platform, attributionToken);
  ...
  webAction(url, publisherId, platform, attributionToken, ctx, originalUrl) {
    ...
    try {
      ...
      webAction = kokiriConfig
        .createBuilderByUrl(publisherId, url)
        .webActionFromUrl(url, platform, attributionToken);
