...
class KokiriConfig {
  constructor(
    ...
    this._webToAppMappings = comstoreCollections.webToAppMappings || [];
    this._approvals = comstoreCollections.approvals || [];
    this._partnerParameters = comstoreCollections.partnerParameters || [];
    this._partnerValues = comstoreCollections.partnerValues || [];
    this._errorLogger = comstoreCollections.errorLogger || {};
  }
   ...
   */
  getPartnerValue(name, owner, partner) {
