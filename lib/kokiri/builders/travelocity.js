...
// Affiliation testing incomplete; in progress as of 9/21.
//
const AFFCID_TRAVELOCITY_NAME = 'affcid';

// 300843 is the Button default value
//
const AFFCID_TRAVELOCITY_FALLBACK = '300843';
...
class Travelocity extends LinkBuilder {
  ...
  affcid(destination) {
    return [
      `TRAVELOCITY-${this.region(destination)}`,
      'NETWORK',
      'BUTTON',
      this.getPartnerValue(
        AFFCID_TRAVELOCITY_NAME,
        AFFCID_TRAVELOCITY_FALLBACK
      ),
    ].join('.');
  }
