...
class Ebay extends LinkBuilder {
  pub() {
    const pubFromConfig = get(Ebay.pubTokenMap, this.publisherId, '5575211063');
    return this.getPartnerValue('pub', pubFromConfig);
  }
  ...
  campid() {
    ...
    return this.getPartnerValue('campid', campaignFromConfig);
  }
