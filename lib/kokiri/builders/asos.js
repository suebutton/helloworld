...
const PUBREF_NAME = 'pubref';
const PUBREF_FALLBACK = 'button';
...
class Asos extends LinkBuilder {
  pubref() {
    return this.getPartnerValue(PUBREF_NAME, PUBREF_FALLBACK);
  }
