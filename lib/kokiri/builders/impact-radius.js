...
class ImpactRadius extends LinkBuilder {
  ...
  url(destination) {
    ...
    // See PEP-19074 for more details
    if (
      this.merchantId === 'org-5e3b5b2c179441ab' ||
      this.merchantId === 'org-02e36380c082e7ab'
    ) {
      return 'https://www.barkbox.com/super-chewer';
    }
...
ImpactRadius.MerchantMap = {
  ...
  'org-5359dcc33f0dc944': {
    hostname: 'bespoke.evyy.net',
    pathId: '73528/1804',
  },
  'org-724a17903d774a25': {
    hostname: 'bespoke.evyy.net',
    pathId: '73528/1804',
  },
  ...
  'org-7c4e6102952fec04': {
    hostname: 'crocs-us.pxf.io',
    pathId: '8119',
  },
  'org-54ff35e2d5b23a92': {
    hostname: 'crocs-us.pxf.io',
    pathId: '8119',
  },
  ...
  'org-51e7ef796640f2bc': {
    hostname: 'kiwi-crate.7eer.net',
    pathId: '330334/4034',
  },
  'org-3f5fc3e809e3105c': {
    hostname: 'kiwi-crate.7eer.net',
    pathId: '330334/4034',
  },
  'org-5d5dca527beb3bd7': {
    hostname: 'lorex-flir.sjv.io',
    pathId: '348371/5143',
  },
  'org-431e2b0a2f7ed3dd': {
    hostname: 'lorex-flir.sjv.io',
    pathId: '348371/5143',
  },
  ...
  'org-5e3b5b2c179441ab': {
    hostname: 'superchewer.7eer.net',
    pathId: '269883/4355',
  },
  'org-02e36380c082e7ab': {
    hostname: 'superchewer.7eer.net',
    pathId: '269883/4355',
  },
  ...
  'org-0f780698890aab70': {
    hostname: 'apple.sjv.io',
    pathId: '551957/7613',
  },
  'org-63b88d00c5c45c1c': {
    hostname: 'apple.sjv.io',
    pathId: '551957/7613',
  },
};

// Ibotta, Samsung, Shopkick, & Button Demo all share the 415484 account.
// CoinOut, Earny, SimpleFund, & United all share the 1299050 account.
// We will eventually split Publishers into their own accounts; no ETA.
ImpactRadius.PublisherMap = {
  ...
  'org-69b30e01a38c2373': '1299050', // United Airlines
  'org-7c2c5deb7e65f900': '1299050', // Fanli
};
