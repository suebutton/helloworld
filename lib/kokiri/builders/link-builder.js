...
class LinkBuilder {
  ...
  webAction(destination, platform, attributionToken) {
    ...
    const appLink = appDestination
      ? this.webActionUniversalLink(appDestination, platform, attributionToken)
      : null;
  ...
  /**
   * TODO(will): rename `universalLink`
   *
   ...
   * @return {string}
   */
  webActionUniversalLink(appDestination, platform, attributionToken) {
  ...
  /**
   * TODO(will): rename destination to appDestination
   *
